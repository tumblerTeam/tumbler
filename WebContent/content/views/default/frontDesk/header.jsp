...
<div class="header">
	<div class="header_box">
    	<ul class="header_nav">
            ...
            <li class="nav4">
            	<a href="#">我的酒翁<img src="content/static/images/header_icon1.png"/></a>
            </li>
            <li class="nav5">
            	<a href="#">购物车<img src="content/static/images/header_icon1.png"/></a>
            </li>
        </ul>
    </div>
</div>
...
<div class="head">
	<div class="head_box">
		<div class="logo"><a href="index"><img src="content/static/images/logo.png"/></a>
		</div>
        <div class="search" >
        	<input placeholder="输入您想购买的商品名称"  class="text"/>

		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					标题：&nbsp;<a href="management/famousManorList"><font color="blue">${famousManor.manorName }</font> <span class="badge navbar-right">返回</span></a>
				</h3>
			</div>
				...
				<div class="form-group">
					<div class="col-sm-12">
						<p class="col-sm-12  control-p">
							<img alt="" src="${famousManor.logoPath }">
						</p>
					</div>
				</div>
			</div>
			<div class="panel-body">
				<div class="form-group">
					<div class="col-sm-12">
						<p class="col-sm-12  control-p">${famousManor.describes }</p>
					</div>
				</div>
			</div>
		</div>

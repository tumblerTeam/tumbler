...
<script>
     $(function(){
    		     $("input[name='judge']").next().css("text-decoration","none").css("color","#444");
     });
</script>
</head>
<body>
	...
	<div class="personal">
		...
		<div class="personal_center">
           ...
           <div class="all1">
                ...
                <a href="user/perscentBonuses?orderDate=-1&orderStatus=-1"><div class="chakan" >查看全部订单</div></a>
           </div>
           <div class="all2">
           		<ul>
                    <c:if test="${fn:length(orderForm.commodities)>3}">
                           <c:forEach items="${orderForm.commodities}" begin="1" end="3"  var="commodity">
                                         <a href="all_order.html#all1"><li><img src=" ${commodity.shopCommodity.shopCommImages[0].imagePath}"   style="width: 60px;height: 80px"/></li></a>
                           </c:forEach>
                    </c:if>
                    <c:if test="${fn:length(orderForm.commodities)<=3}">
                    ...
                    <a href="user/perscentBonuses?orderDate=-1&orderStatus=-1"><li><img src="content/static/images/dian.jpg" /></li></a>
                    ...
                    <li><div style="margin-top:20px;"><p>￥
                    <fmt:formatNumber  value="${total}" pattern="##.##" minFractionDigits="2"></fmt:formatNumber></p><p>在线支付</p></div></li>
                    <li><div style="margin-top:20px;"><p>${orderForm.orderTime}</p></div></li>
                    <li><div style="margin-top:20px;"><p><c:choose>
										...
										<c:when test="${orderForm.orderstatus =='efundSuccess'}">退款成功</c:when>

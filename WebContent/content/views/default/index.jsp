...
<div class="banner">
	...
	<div class="main_box">
						...
						<c:if test="${loop.index<5 }">
							<c:choose>
								<c:when test="${loop.index%2==0 }">
									<li><a href="#">${famous.manorName }</a></li>
								</c:when>
								<c:otherwise>
			...
			<ul class="column_01">
				<c:forEach items="${famouss }" var="famous" varStatus="loop">
					<c:if test="${loop.index <8  }">
						...
						<a href="#"><img src="${famous.logoPath }" />
							<h1>
								<span style="margin-right: 0.5em"></span>${famous.manorName }
							</h1></a>
						<p>
							<a href="#">${famous.title }</a>
						</p>
		...
		<div class="column_02">
			...
			<div class="main_02">
				<div class="jg1">
					...
					<ul class="jg_list1">
						<li style="margin-top: 10px;"><a href="#">干红</a></li>
						<li style="margin-top: 10px;"><a href="#">半干红</a></li>
						<li><a href="#">甜红</a></li>
						<li><a href="#">半甜红</a></li>
						<li><a href="#">干白</a></li>
						<li><a href="#">半干白</a></li>
				...
				<div class="jg2">
					<a href="#"><img src="content/static/img/jg_banner.jpg" /></a>
				</div>
				<ul class="jg3">
					...
					<c:if test="${loop.index != 5 }">
						...
						<div class="p_img">
							<a href="#"><img src="${hong.shopCommImages[0].imagePath }" /></a>
						</div>
						<div class="p_name">
		...
		<div class="column_03">
			...
			<div class="main_02">
				<div class="jg1">
					...
					<ul class="jg_list1">
						<li style="margin-top: 20px;"><a href="#">茅台</a></li>
						<li style="margin-top: 20px;"><a href="#">五粮液</a></li>
						<li><a href="#">汾酒</a></li>
						<li style="padding: 0px 15px;"><a href="#">泸州老窖</a></li>
						<li><a href="#">酱香型</a></li>
						<li style="padding: 0px 15px;"><a href="#">浓香型</a></li>
					</ul>
					<div class="list_02">
						<p>
							<b>白酒产区</b>
				...
				<div class="jg2">
					<a href="#"><img src="content/static/img/jg_banner2.jpg" /></a>
				</div>
				<ul class="jg3">
					...
					<c:if test="${loop.index != 5 }">
						...
						<div class="p_img">
							<a href="#"><img src="${bai.shopCommImages[0].imagePath }" /></a>
						</div>
						<div class="p_name">
							<div class="p_name_text">
								<a href="#">
		...
		<div class="column_04">
			...
			<div class="main_02">
				<div class="jg1">
					...
					<ul class="jg_list1">
						<li style="margin-top: 20px;"><a href="#">威士忌</a></li>
						<li style="margin-top: 20px;"><a href="#">伏特加</a></li>
						<li><a href="#">力娇酒</a></li>
						<li><a href="#">白兰地</a></li>
						<li><a href="#">朗姆酒</a></li>
						<li><a href="#">干邑</a></li>
				...
				<div class="jg2">
					<a href="#"><img src="content/static/img/yjg_banner.jpg" /></a>
				</div>
				<ul class="jg3">
					...
					<c:if test="${loop.index != 5 }">
						...
						<div class="p_img">
							<a href="#"><img src="${yang.shopCommImages[0].imagePath }" /></a>
						</div>
						<div class="p_name">
							<div class="p_name_text">
								<a href="#">
		...
		<div class="column_05">
			...
			<div class="main_02">
				<div class="jg1">
					...
					<ul class="jg_list1">
						<li style="margin-top: 20px;"><a href="#">青岛</a></li>
						<li style="margin-top: 20px;"><a href="#">瓦伦丁</a></li>
						<li><a href="#">奥丁格</a></li>
						<li style="padding: 0px 15px;"><a href="#">百威</a></li>
						<li><a href="#">雪花</a></li>
						<li style="padding: 0px 15px;"><a href="#">喜力</a></li>
					</ul>
					<div class="list_02">
						<p>
							<b>啤酒类型</b>
				...
				<ul class="jg3">
					...
					<c:if test="${loop.index != 5 }">
						...
						<div class="p_img">
							<a href="#"><img src="${pi.shopCommImages[0].imagePath }" /></a>
						</div>
						<div class="p_name">
							<div class="p_name_text">
								<a href="#">
		...
		<!--banner2-->
		<div class="banner2">
			<a href="#"><img src="content/static/img/banner3.jpg" /></a>
		</div>
		...
		<div class="column_06">
			...
			<div class="main_02">
				...
				<div class="jg2">
					<a href="#"><img src="content/static/img/ot_banner.jpg" /></a>
				</div>
				<ul class="jg3">
					<li>
						<div class="p_img">

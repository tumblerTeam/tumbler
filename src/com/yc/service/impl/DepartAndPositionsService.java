...
public class DepartAndPositionsService extends GenericService<DepartAndPositions> implements IDepartAndPositionsService {
	...
	@Override
	public List<DepartAndPositions> findDepAndPosByDep(Integer departmentID) {
		StringBuffer hql = new StringBuffer("select * from DepartAndPositions depAndPos where depAndPos.departments_id = "+departmentID);
